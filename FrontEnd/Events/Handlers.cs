...
namespace FrontEnd.Events
{
    ...
    /// <summary>
    /// This delegate works as a bridge between the <see cref="FrontEnd.Controller.AbstractFormListController{M}"/> and a <see cref="FrontEnd.Recordsource.RecordSource{M}"/>.
    /// <para/>
    /// If any filter operations has been implemented in the Controller, The RecordSource can trigger them.
    /// <para/>
    /// This delegate is called in the <see cref="Backend.Recordsource.IChildSource.Update(Backend.Database.CRUD, Backend.Model.ISQLModel)"/>
    /// </summary>
